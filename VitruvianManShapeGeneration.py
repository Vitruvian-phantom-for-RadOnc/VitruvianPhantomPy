...
def main():
    ...
    shift_function = lambda x: 0.  # No shift, all shapes are centered at the origin
    ...
    # # High Resolution
    if args.do_HR:
        print('\nProcessing High Resolution geometry')
        try:
            spacing = [0.5, 0.5, 0.5]
            ...
            if create_rtss:
                if CC_VitruvianMan_shapes_list != None:
                    print('\tCreating Cesare Cesariano Vitruvian Man shapes')
